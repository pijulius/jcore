   ...
   jQuery.fn.qtip = function(options, blanket)
   {
      ...
      return jQuery(this).each(function() // Return original elements as per jQuery guidelines
      {
         ...
         if(typeof options == 'string')
         {
            ...
            // Make sure API data exists jQuery('.qtip').qtip('destroy')
         ...
         else
         {
            ...
            if(typeof jQuery(this).data == 'object' && typeof jQuery(this).data('qtip') == 'object')
            {
      ...
      jQuery.extend(self, self.options.api,
      {
         ...
         updateWidth: function(newWidth)
         {
            ...
            if(jQuery.browser.msie)
            {
               ...
               // Set the new width
               self.elements.wrapper.width('auto');
