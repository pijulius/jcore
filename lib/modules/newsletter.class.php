		...
		echo
			"<td align='center'>" .
				"<a class='admin-link newsletter-members' " .
					"title='".htmlchars(_("Members"), ENT_QUOTES) .
					" (".$members['Rows'].")' " .
		...
		if ($invalidemails) {
			tooltip::display(
				sprintf(_("Invalid email addresses defined. " .
					...
					"addresses: %s."),
					htmlchars(implode(', ', $invalidemails))),
				TOOLTIP_ERROR);
	...
	function displayAdminListFunctions() {
		echo
			"<input type='submit' name='confirmsubmit' value='".
				htmlchars(_("Confirm"), ENT_QUOTES)."' class='button' /> " .
			"<input type='submit' name='confirmallsubmit' value='".
				htmlchars(_("Confirm All"), ENT_QUOTES)."' class='button' /> " .
			"<input type='submit' name='deletesubmit' value='".
				htmlchars(_("Delete"), ENT_QUOTES)."' class='button confirm-link' /> " .
			"<input type='submit' name='deleteallsubmit' value='".
				htmlchars(_("Delete All"), ENT_QUOTES)."' class='button confirm-link' /> ";
	}
	...
	function displayAdmin() {
		...
		if ($form->get('PreviewSubmit') || $form->get('SendSubmit')) {
			...
			if ($emailssent) {
				...
				if ($form->get('LimitEmails')) {
					...
					echo
						...
						"<input type='submit' name='SendSubmit' value='" .
							htmlchars(sprintf(_('Send next %s Emails'),
				...
				echo
					"<input type='button' " .
						"value='".htmlchars(_('View Newsletters'), ENT_QUOTES)."' " .
						"class='button' " .
		...
		if ($this->userPermissionType & USER_PERMISSION_TYPE_WRITE &&
			(!$this->userPermissionIDs || ($resend && $selected)))
		{
	...
	function displayAdminSections() {
		...
		echo
				"<a href='".url::uri('ALL') .
					...
					"title='".htmlchars(_("Send and View sent " .
		...
		echo
				"<a href='".url::uri('ALL') .
					...
					"title='".htmlchars(_("Import, Edit and Delete " .
		...
		echo
				"<a href='".url::uri('ALL') .
					...
					"title='".htmlchars(_("Create, Modify and " .
